...
public class ModuleLoader {
    ...
    private final PaperConnectorApi pluginApi;
    ...
    public ModuleLoader(PaperConnectorApi pluginApi, ModuleApi moduleApi) {
    ...
    private void loadModule(ModuleDescriptor descriptor) throws Exception {
        ...
        if (module instanceof ConnectorModule) {
            ...
            connectorModule.setPluginApi(pluginApi);
        }

        // Register the module (but don't enable it yet)
        moduleApi.registerModule(module);

        // Enable the module
        moduleApi.enableModule(descriptor.getId());
    ...
    public void unloadModule(String moduleId) throws Exception {
        ...
        moduleApi.unregisterModule(moduleId);
