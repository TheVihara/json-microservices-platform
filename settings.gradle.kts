...
include("minecraft:paper:attribute-system")
include("minecraft:paper:essentials:api")
include("minecraft:paper:knowledge-system")
include("minecraft:paper:item-system")
include("minecraft:paper:item-system:api")
include("minecraft:paper:gui-system-module")